...
interface Props {
  ...
  toolbar?: ReactNode;
  stats?: PageHeroStat[];
  /** `article` = case study detail (narrower, smaller title). */
...
export default function PageHero({
  ...
  return (
    <header
      className={`page-hero page-hero-offset ${isArticle ? "page-hero--article" : ""}`}
    >
      ...
      <div className="page-content page-hero__shell">
        {back && (
